...
**Your personal, no-bullshit backend for content you care about.**

## What This Is

7 curated YouTube channels with 350+ videos. One command to summarize any of them. Auto-organized output.

```bash
pnpm summarize "https://youtube.com/watch?v=Hrbq66XqtCo"
```

That's it. No algorithm, no rabbit holes. Just your inputs, your control.

## Structure

```
stuff-to-summarize/          # Your channel queues (7 markdown files)
├─ dwarkesh-podcast-videos.md
├─ lex-fridman-podcast.md
├─ no-priors-podcast.md
├─ simnett-nutrition-videos.md
├─ plantstrong-podcast.md
├─ plant-based-jane-ann-esselstyn.md
└─ ann-jane-plant-podcast.md

summaries/                    # Auto-created, organized by channel
├─ dwarkesh-podcast-videos/
├─ lex-fridman-podcast/
└─ ...

DRIVER.md                     # Status & channel list (this is your dashboard)
SUMMARIZE-SYSTEM.md          # Full philosophy & details
```

## Quick Start

1. **Open a channel** → `stuff-to-summarize/dwarkesh-podcast-videos.md`
2. **Pick a video** → Copy the URL
3. **Summarize** → `pnpm summarize "https://youtube.com/watch?v=..."`
4. **Read** → Summary auto-saves to `summaries/dwarkesh-podcast-videos/`
...
(Copilot slash command — automates fetch + markdown creation)

## Status

**7 channels | 350+ videos | All dated (YYYY-MM-DD)**

See [DRIVER.md](DRIVER.md) for current stats and channels.

---

## The Summarize Tool (Reference)

Everything below is the underlying **@steipete/summarize** package. Your hub uses this under the hood.
